...
> [!NOTE]
> This is an unmodified re-upload of [TinyMCE version 4.9.11](https://github.com/tinymce/tinymce/releases/tag/4.9.11), which was being used in legacy WordPress systems.
> I'm preserving it for easy access to the unminified source code of that version, as it is very
> hard to find on the `tinymce/tinymce` repo.
